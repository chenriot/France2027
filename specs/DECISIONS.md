...
| Tableaux | **319** (migrés + 5 ajoutés §D17 + 15 écrits dans le document d’origine, §D14) | `npm run check:data` |
...
| **Rendu de `/tout`** | **60 595 éléments, 29 corrections déclarées, aucun écart non déclaré** | `npm run check:render` |
