...
| Tableaux | **327** (migrés + 5 ajoutés §D17 + 23 écrits dans le document d’origine, §D14) | `npm run check:data` |
...
| **Rendu de `/tout`** | **62 316 éléments, 29 corrections déclarées, aucun écart non déclaré** | `npm run check:render` |
