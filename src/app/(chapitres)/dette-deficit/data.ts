    ...
    columns: [
      {
        ...
        header: 'PIB par habitant, USD à parités de pouvoir d\'achat constantes de 2021',
        type: 'text',
        headerNumeric: false,
      },
      ...
      { key: '2005-2025', header: '2005 → 2025', type: 'number', headerNumeric: true },
      { key: 'gain-annuel-moyen', header: 'Gain annuel moyen', type: 'number', headerNumeric: true },
    ],
    rows: [
      {
        cells: [
          ...
          { v: 59501, d: 0 },
          { v: 64291, d: 0 },
          { v: 76834, d: 0, strong: true },
          { v: 29.1, d: 1, u: '%', sign: true, strong: true },
          { v: 867, d: 0, u: '$', sign: true },
        ],
        emphasis: true,
      },
      {
        cells: [
          ...
          { v: 63066, d: 0 },
          { v: 71271, d: 0 },
          { v: 22.1, d: 1, u: '%', sign: true },
          { v: 646, d: 0, u: '$', sign: true },
        ],
      },
      {
        cells: [
          ...
          { v: 59858, d: 0 },
          { v: 62888, d: 0 },
          { v: 21.2, d: 1, u: '%', sign: true },
          { v: 549, d: 0, u: '$', sign: true },
        ],
      },
      {
        cells: [
          ...
          { v: 48376, d: 0 },
          { v: 50890, d: 0 },
          { v: 55197, d: 0, strong: true },
          { v: 14.1, d: 1, u: '%', sign: true, strong: true },
          { v: 341, d: 0, u: '$', sign: true },
        ],
        emphasis: true,
      },
      {
        cells: [
          ...
          { v: 50458, d: 0 },
          { v: 53832, d: 0 },
          { v: 11.5, d: 1, u: '%', sign: true },
          { v: 277, d: 0, u: '$', sign: true },
        ],
      },
      {
        cells: [
          ...
          { v: 14821, d: 0 },
          { v: 25147, d: 0 },
          { v: 300.4, d: 1, u: '%', sign: true },
          { v: 943, d: 0, u: '$', sign: true },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        ...
        header: 'Endettement net nouveau, moyenne annuelle 2006-2025',
        type: 'text',
        headerNumeric: false,
      },
      { key: 'total-du-pib', header: 'Total, % du PIB', type: 'number', headerNumeric: true },
      {
        key: 'dont-administrations-publiques',
        header: 'dont administrations publiques',
        type: 'number',
        headerNumeric: true,
      },
      {
        key: 'dont-menages-et-entreprises',
        header: 'dont ménages et entreprises',
        type: 'number',
        headerNumeric: true,
      },
    ],
    ...
    columns: [
      {
        ...
        header: 'Stock de dette non financière par habitant, 2025',
        type: 'text',
        headerNumeric: false,
      },
    ...
    columns: [
      {
        ...
        header: 'Cumul 2006-2025, par habitant, USD à parités constantes de 2021',
        type: 'text',
        headerNumeric: false,
      },
      {
      ...
      {
        key: 'endettement-net-cumule',
        header: 'Endettement net cumulé',
        type: 'number',
        headerNumeric: true,
      },
      {
        key: 'dette-par-dollar-produit-en-plus',
        header: 'Dette par dollar produit en plus',
        type: 'number',
        headerNumeric: true,
      },
    ],
