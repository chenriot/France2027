...
61 566 éléments, 29 corrections déclarées, aucun écart non déclaré.
...
Le site est construit et vérifié : 21 chapitres, 325 tableaux, 58 figures,
217 sources, 28 routes prérendues, toutes sous la charte (§D18). `/tout` rend 61 566 éléments avec
