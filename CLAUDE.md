...
61 951 éléments, 29 corrections déclarées, aucun écart non déclaré.
...
Le site est construit et vérifié : 21 chapitres, 328 tableaux, 64 figures,
232 sources, 28 routes prérendues, toutes sous la charte (§D18). `/tout` rend 61 951 éléments avec
...
URL des sources (10 renseignées sur 232), millésimes à confirmer, 23 figures dont le tracé n'est pas
