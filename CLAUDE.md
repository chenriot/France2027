...
61 054 éléments, 29 corrections déclarées, aucun écart non déclaré.
...
Le site est construit et vérifié : 21 chapitres, 322 tableaux, 64 figures,
224 sources, 28 routes prérendues, toutes sous la charte (§D18). `/tout` rend 61 054 éléments avec
